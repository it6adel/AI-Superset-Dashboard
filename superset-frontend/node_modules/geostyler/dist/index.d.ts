...
declare const locale: {
    de_DE: GeoStylerLocale;
    en_US: GeoStylerLocale;
    es_ES: GeoStylerLocale;
    fr_FR: GeoStylerLocale;
    zh_CN: GeoStylerLocale;
};
export { AttributeCombo, BoolFilterField, Breadcrumb, BrightnessField, BulkEditModals, BulkEditor, CardStyle, ChannelField, ChannelSelectionField, CodeEditor, ColorField, ColorMapEditor, ColorMapEntryField, ColorMapTypeField, ColorRampCombo, ComparisonFilter, CompositionContext, ConfigProvider, ContrastEnhancementField, ContrastField, DataLoader, DataProvider, DefaultValueContext, Editor, ExtendedField, FadeDurationField, FieldContainer, FieldSet, FillEditor, FilterEditorWindow, FilterOverview, FilterTree, FontPicker, GammaField, GeoStylerContext, GraphicEditor, GraphicTypeField, GrayChannelField, IconEditor, IconSelector, IconSelectorWindow, ImageField, KindField, LineCapField, LineDashField, LineEditor, LineJoinField, locale, localize, MarkEditor, MaxScaleDenominator, MinScaleDenominator, MultiEditor, NameField, NumberFilterField, OffsetField, OlRenderer, OpacityField, OperatorCombo, Preview, PreviewMap, PropTextEditor, RadiusField, RasterChannelEditor, RasterEditor, RemoveButton, RemovableItem, Renderer, RgbChannelField, ResamplingField, RotateField, Rule, RuleCard, RuleFieldContainer, RuleGenerator, RuleGeneratorWindow, RuleOverview, Rules, RuleTable, SaturationField, ScaleDenominator, Selectable, SelectableItem, SizeField, SLDRenderer, SortableItem, SourceChannelNameField, Style, StyleFieldContainer, StyleLoader, StyleOverview, SymbolizerCard, SymbolizerEditorWindow, Symbolizers, TextEditor, TextFilterField, UploadButton, UnsupportedPropertiesContext, WellKnownNameEditor, WellKnownNameField, WidthField, withDefaultsContext, GeoStylerLocale };
