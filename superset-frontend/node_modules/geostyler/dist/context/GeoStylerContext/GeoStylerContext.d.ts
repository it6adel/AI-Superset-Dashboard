...
import { ContrastEnhancementFieldProps } from '../../Component/Symbolizer/Field/ContrastEnhancementField/ContrastEnhancementField';
...
export declare const useGeoStylerContext: () => any;
export declare const useGeoStylerComposition: <T extends keyof CompositionContext>(key: T, fallback?: any) => CompositionContext[T];
export declare const useGeoStylerLocale: <T extends keyof GeoStylerLocale>(key: T) => GeoStylerLocale[T];
export declare const useGeoStylerUnsupportedProperties: () => any;
