...
import { i as isEmotionCssPropElementType, e as isStyledElementType, u as unwrapFromPotentialFragment, c as createSerializer$1, t as tickle } from './create-serializer-f94a97a2.esm.js';
...
function createEnzymeSerializer(_temp) {
  ...
  return {
    ...
    serialize: function serialize(node, config, indentation
    /*: string */
    , depth
    /*: number */
    , refs, printer
