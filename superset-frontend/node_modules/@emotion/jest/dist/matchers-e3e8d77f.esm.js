...
import { g as getClassNamesFromNodes, a as getStylesFromClassNames, b as getStyleElements, d as getMediaRules, h as hasClassNames, f as findLast } from './create-serializer-f94a97a2.esm.js';
...
/* ?: { target?: string | RegExp, media?: string } */
) {
  if (options
  /* ?: { target?: string | RegExp, media?: string } */
  === void 0) {
