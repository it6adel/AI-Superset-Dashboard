...
exports.defaultTranslations = {
    en: {
        marksymbolizerParseFailedUnknownWellknownName: 'MarkSymbolizer cannot be parsed. WellKnownName {{wellKnownName}} is not supported.',
    ...
    de: {},
    fr: {
        marksymbolizerParseFailedUnknownWellknownName: 'Échec de lecture du symbole de type MarkSymbolizer. Le WellKnownName {{wellKnownName}} n\'est pas supporté.',
...
var SldStyleParser = /** @class */ (function () {
    function SldStyleParser(opts) {
        ...
        this.translations = exports.defaultTranslations;
        this.locale = 'en';
        /**
        ...
        this.parser = new fast_xml_parser_1.XMLParser(__assign(__assign({}, opts === null || opts === void 0 ? void 0 : opts.parserOptions), { 
            // Fixed attributes
            cdataPropName: '#cdata', ignoreDeclaration: true, removeNSPrefix: true, ignoreAttributes: false, preserveOrder: true, trimValues: true }));
        ...
        if (opts === null || opts === void 0 ? void 0 : opts.locale) {
            this.locale = opts.locale;
        }
        if (opts === null || opts === void 0 ? void 0 : opts.translations) {
            this.translations = (0, lodash_1.merge)(this.translations, opts.translations);
        }
    ...
    SldStyleParser.prototype.translate = function (key, params) {
    ...
    Object.defineProperty(SldStyleParser.prototype, "readingSldVersion", {
        /**
    ...
    SldStyleParser.prototype.readStyle = function (sldString) {
        ...
        return new Promise(function (resolve) {
            try {
                ...
                var version = (0, SldUtil_1.getAttribute)(sldObject[0], 'version');
                if (!SLD_VERSIONS.includes(version)) {
                    throw new Error("SLD version must be ".concat(SLD_VERSIONS.toString()));
                }
                _this._readingSldVersion = version;
    ...
    SldStyleParser.prototype.getStyleNameFromSldObject = function (sldObject) {
        var userStyleTitle = (0, SldUtil_1.get)(sldObject, 'StyledLayerDescriptor.NamedLayer[0].UserStyle.Name.#text');
    ...
    SldStyleParser.prototype.getSymbolizersFromRule = function (sldRule) {
        ...
        var symbolizers = sldRule
            ...
            switch (sldSymbolizerName) {
                ...
                default:
                    throw new Error(_this.translate('symbolizerKindParseFailed', { sldSymbolizerName: sldSymbolizerName }));
            }
        });
        return symbolizers;
    };
    ...
    SldStyleParser.prototype.getFilterFromOperatorAndComparison = function (sldOperatorName, sldFilter) {
        ...
        if (sldOperatorName === 'PropertyIsBetween') {
            ...
            var comparisonOperator = COMPARISON_MAP[sldOperatorName];
            ...
            var combinationOperator = COMBINATION_MAP[sldOperatorName];
            ...
            var negationOperator = NEGATION_OPERATOR_MAP[sldOperatorName];
    ...
    SldStyleParser.prototype.getLineSymbolizerFromSldSymbolizer = function (sldSymbolizer) {
        ...
        var strokeEl = (0, SldUtil_1.get)(sldSymbolizer, 'Stroke', this.readingSldVersion);
        var color = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke', this.readingSldVersion);
        var width = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-width', this.readingSldVersion);
        var opacity = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-opacity', this.readingSldVersion);
        var lineJoin = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-linejoin', this.readingSldVersion);
        var lineCap = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-linecap', this.readingSldVersion);
        var dashArray = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-dasharray', this.readingSldVersion);
        var dashOffset = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-dashoffset', this.readingSldVersion);
        if (!(0, lodash_1.isNil)(color)) {
            lineSymbolizer.color = color;
        }
        if (!(0, lodash_1.isNil)(width)) {
            lineSymbolizer.width = (0, SldUtil_1.numberExpression)(width);
        }
        if (!(0, lodash_1.isNil)(opacity)) {
            lineSymbolizer.opacity = (0, SldUtil_1.numberExpression)(opacity);
        }
        if (!(0, lodash_1.isNil)(lineJoin)) {
        ...
        if (!(0, lodash_1.isNil)(graphicStroke)) {
        ...
        if (!(0, lodash_1.isNil)(graphicFill)) {
        ...
        if (!(0, lodash_1.isNil)(perpendicularOffset)) {
    ...
    SldStyleParser.prototype.getTextSymbolizerFromSldSymbolizer = function (sldSymbolizer) {
        ...
        var color = (0, SldUtil_1.getParameterValue)(fillEl, 'fill', this.readingSldVersion);
        var opacity = (0, SldUtil_1.getParameterValue)(fillEl, 'fill-opacity', this.readingSldVersion);
        var fontFamily = (0, SldUtil_1.getParameterValue)(fontEl, 'font-family', this.readingSldVersion);
        var fontStyle = (0, SldUtil_1.getParameterValue)(fontEl, 'font-style', this.readingSldVersion);
        var fontSize = (0, SldUtil_1.getParameterValue)(fontEl, 'font-size', this.readingSldVersion);
        var fontWeight = (0, SldUtil_1.getParameterValue)(fontEl, 'font-weight', this.readingSldVersion);
        var haloColor = (0, SldUtil_1.getParameterValue)(haloFillEl, 'fill', this.readingSldVersion);
        if (!(0, lodash_1.isNil)(labelEl)) {
        ...
        if (!(0, lodash_1.isNil)(haloRadius)) {
            textSymbolizer.haloWidth = (0, SldUtil_1.numberExpression)(haloRadius);
        }
        var haloOpacity = (0, SldUtil_1.getParameterValue)(haloFillEl, 'fill-opacity', this.readingSldVersion);
        if (!(0, lodash_1.isNil)(haloOpacity)) {
            textSymbolizer.haloOpacity = (0, SldUtil_1.numberExpression)(haloOpacity);
        }
        if (!(0, lodash_1.isNil)(haloColor)) {
            textSymbolizer.haloColor = haloColor;
        }
        var placement = (0, SldUtil_1.get)(sldSymbolizer, 'LabelPlacement');
        if (!(0, lodash_1.isNil)(placement)) {
            var pointPlacement = (0, SldUtil_1.get)(placement, 'PointPlacement');
            var linePlacement = (0, SldUtil_1.get)(placement, 'LinePlacement');
            if (!(0, lodash_1.isNil)(pointPlacement)) {
                textSymbolizer.placement = 'point';
                var displacement = (0, SldUtil_1.get)(pointPlacement, 'Displacement');
                if (!(0, lodash_1.isNil)(displacement)) {
                    ...
                    textSymbolizer.offset = [
                        Number.isFinite(x) ? (0, SldUtil_1.numberExpression)(x) : 0,
                        Number.isFinite(y) ? -(0, SldUtil_1.numberExpression)(y) : 0,
                    ];
                }
                var rotation = (0, SldUtil_1.get)(pointPlacement, 'Rotation.#text');
                if (!(0, lodash_1.isNil)(rotation)) {
                    textSymbolizer.rotate = (0, SldUtil_1.numberExpression)(rotation);
                }
            }
            else if (!(0, lodash_1.isNil)(linePlacement)) {
                textSymbolizer.placement = 'line';
            }
        }
        if (!(0, lodash_1.isNil)(fontFamily)) {
            textSymbolizer.font = [fontFamily];
        }
        if (!(0, lodash_1.isNil)(fontStyle)) {
            textSymbolizer.fontStyle = fontStyle.toLowerCase();
        }
        if (!(0, lodash_1.isNil)(fontWeight)) {
            textSymbolizer.fontWeight = fontWeight.toLowerCase();
        }
        if (!(0, lodash_1.isNil)(fontSize)) {
    ...
    SldStyleParser.prototype.getFillSymbolizerFromSldSymbolizer = function (sldSymbolizer) {
        ...
        var fillEl = (0, SldUtil_1.get)(sldSymbolizer, 'Fill');
        var fillOpacity = (0, SldUtil_1.getParameterValue)(fillEl, 'fill-opacity', this.readingSldVersion);
        var color = (0, SldUtil_1.getParameterValue)(fillEl, 'fill', this.readingSldVersion);
        var outlineColor = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke', this.readingSldVersion);
        var outlineWidth = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-width', this.readingSldVersion);
        var outlineOpacity = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-opacity', this.readingSldVersion);
        var outlineDashArray = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-dasharray', this.readingSldVersion);
        var outlineCap = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-linecap', this.readingSldVersion);
        var outlineJoin = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-linejoin', this.readingSldVersion);
    ...
    SldStyleParser.prototype.getRasterSymbolizerFromSldSymbolizer = function (sldSymbolizer) {
        ...
        if (!(0, lodash_1.isNil)(sldColorMap)) {
        ...
        if (!(0, lodash_1.isNil)(sldChannelSelection)) {
        ...
        if (!(0, lodash_1.isNil)(sldContrastEnhancement)) {
    ...
    SldStyleParser.prototype.getMarkSymbolizerFromSldSymbolizer = function (sldSymbolizer) {
        ...
        var fillOpacity = (0, SldUtil_1.getParameterValue)(fillEl, 'fill-opacity', this.readingSldVersion);
        var color = (0, SldUtil_1.getParameterValue)(fillEl, 'fill', this.readingSldVersion);
        var displacement = (0, SldUtil_1.get)(sldSymbolizer, 'Graphic.Displacement');
        var markSymbolizer = {
            kind: 'Mark',
        ...
        var strokeColor = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke', this.readingSldVersion);
        if (!(0, lodash_1.isNil)(strokeColor)) {
            markSymbolizer.strokeColor = strokeColor;
        }
        var strokeWidth = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-width', this.readingSldVersion);
        if (!(0, lodash_1.isNil)(strokeWidth)) {
            markSymbolizer.strokeWidth = (0, SldUtil_1.numberExpression)(strokeWidth);
        }
        var strokeOpacity = (0, SldUtil_1.getParameterValue)(strokeEl, 'stroke-opacity', this.readingSldVersion);
        if (!(0, lodash_1.isNil)(strokeOpacity)) {
    ...
    SldStyleParser.prototype.getColorMapFromSldColorMap = function (sldColorMap, type, extended) {
        ...
        if (Array.isArray(colorMapEntries)) {
            var cmEntries = colorMapEntries.map(function (cm) {
                ...
                if (!color) {
                    throw new Error(_this.translate('colorMapEntriesParseFailedColorUndefined'));
                }
    ...
    SldStyleParser.prototype.geoStylerStyleToSldObject = function (geoStylerStyle) {
        ...
        rules.forEach(function (rule) {
            var ruleEl = (0, SldUtil_1.get)(rule, _this.getTagName('Rule'));
            var filter = (0, SldUtil_1.getChildren)(ruleEl, 'Filter').at(0);
            if (filter) {
                filter[':@'] = {
        ...
        if (this.sldVersion === '1.0.0') {
            userStyle.push((_b = {},
                _b[Title] = [{ '#text': geoStylerStyle.name || '' }],
                _b));
        }
        userStyle.push((_c = {},
            _c[FeatureTypeStyle] = featureTypeStyle,
            _c));
        return [{
                '?xml': [{ '#text': '' }],
                ':@': {
                ...
                StyledLayerDescriptor: [{
                        NamedLayer: [(_d = {},
                                _d[Name] = [{ '#text': geoStylerStyle.name || '' }],
                                _d), {
                                UserStyle: userStyle
                            }]
                    }],
    ...
    SldStyleParser.prototype.getSldComparisonFilterFromComparisonFilter = function (comparisonFilter) {
        ...
        var sldOperators = (0, SldUtil_1.keysByValue)(COMPARISON_MAP, operator);
    ...
    SldStyleParser.prototype.getSldFilterFromFilter = function (filter) {
        ...
        if ((0, geostyler_style_1.isComparisonFilter)(filter)) {
            ...
            var sldOperators = (0, SldUtil_1.keysByValue)(COMBINATION_MAP, operator);
    ...
    SldStyleParser.prototype.getSldTextSymbolizerFromTextSymbolizer = function (textSymbolizer) {
        ...
        var LinePlacement = this.getTagName('LinePlacement');
        var Rotation = this.getTagName('Rotation');
        ...
        var fontCssParameters = Object.keys(textSymbolizer)
            ...
            if ((0, geostyler_style_1.isGeoStylerFunction)(textSymbolizer[property])) {
                ...
                return _b = {},
                    _b[CssParameter] = [{
                            '#text': property === 'font'
                                ? (_c = textSymbolizer[property]) === null || _c === void 0 ? void 0 : _c[0]
        ...
        if (textSymbolizer.placement === 'line') {
            sldTextSymbolizer.push((_c = {},
                _c[LabelPlacement] = [(_d = {},
                        _d[LinePlacement] = [],
                        _d)],
                _c));
        }
            ...
            if (textSymbolizer.rotate !== undefined) {
                pointPlacement.push((_h = {},
                    _h[Rotation] = [{
                            '#text': textSymbolizer.rotate.toString()
                        }],
                    _h));
            }
            sldTextSymbolizer.push((_j = {},
                _j[LabelPlacement] = [(_k = {},
                        _k[PointPlacement] = pointPlacement,
                        _k)],
                _j));
        }
        if (textSymbolizer.haloWidth || textSymbolizer.haloColor) {
            ...
            if (haloFillCssParameter.length > 0) {
                halo.push((_p = {},
                    _p[Fill] = haloFillCssParameter,
                    _p));
            }
            sldTextSymbolizer.push((_q = {},
                _q[Halo] = halo,
                _q));
        }
    ...
    SldStyleParser.prototype.getSldLineSymbolizerFromLineSymbolizer = function (lineSymbolizer) {
        ...
        var cssParameters = Object.keys(lineSymbolizer)
            ...
            lineSymbolizer[property] !== undefined &&
            lineSymbolizer[property] !== null; })
            .map(function (property) {
            var _a, _b, _c;
    ...
    SldStyleParser.prototype.getSldPolygonSymbolizerFromFillSymbolizer = function (fillSymbolizer) {
        ...
        Object.keys(fillSymbolizer)
            ...
            .filter(function (property) { return fillSymbolizer[property] !== undefined &&
            fillSymbolizer[property] !== null; })
    ...
    SldStyleParser.prototype.checkForUnsupportedProperties = function (geoStylerStyle) {
        var _this = this;
