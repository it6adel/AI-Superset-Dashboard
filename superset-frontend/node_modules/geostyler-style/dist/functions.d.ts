...
export type GeoStylerNumberFunction = GeoStylerUnknownFunction | Fabs | Facos | Fadd | Fasin | Fatan | Fatan2 | Fceil | Fcos | Fdiv | Fexp | Ffloor | Flog | Fmax | Fmin | Fmodulo | Fmul | Fpi | Fpow | Frandom | Frint | Fround | Fsin | Fsqrt | FstrIndexOf | FstrLastIndexOf | FstrLength | Fsub | Ftan | FtoDegrees | FtoRadians;
export type GeoStylerStringFunction = GeoStylerUnknownFunction | FnumberFormat | FstrAbbreviate | FstrCapitalize | FstrConcat | FstrDefaultIfBlank | FstrReplace | FstrStripAccents | FstrSubstring | FstrSubstringStart | FstrToLowerCase | FstrToUpperCase | FstrTrim;
